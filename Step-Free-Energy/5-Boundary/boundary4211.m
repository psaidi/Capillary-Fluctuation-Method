...
% 
% 
%      figure('Position',[300 300 271 550]);
%      
%  
% for i=1:Totz
%     for k=1:Totx
%         rtr=(i-1)*Totx+k;
%         if (AcceptedFinal2(DumpNo,rtr)==0)
%         plot(k,i,'s','MarkerEdgeColor','white','MarkerFaceColor','g')
%          
%         else
%         plot(k,i,'s','MarkerEdgeColor','white','MarkerFaceColor','r')
%          end
%         hold on
%          
% 
...
fprintf(fid1,'%d %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g  %g %g %g %g %g %g %g %g\n', DumpNo...
    ...
    ,AcceptedHeight1(DumpNo,22),AcceptedHeight1(DumpNo,23),AcceptedHeight1(DumpNo,24)...
    ,AcceptedHeight1(DumpNo,25),AcceptedHeight1(DumpNo,26),AcceptedHeight1(DumpNo,27)...
    ,AcceptedHeight1(DumpNo,28),AcceptedHeight1(DumpNo,29)...
    );

fprintf(fid2,'%d %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g  %g %g %g %g %g %g %g %g\n', DumpNo...
    ...
    ,AcceptedHeight2(DumpNo,22),AcceptedHeight2(DumpNo,23),AcceptedHeight2(DumpNo,24)...
    ,AcceptedHeight2(DumpNo,25),AcceptedHeight2(DumpNo,26),AcceptedHeight2(DumpNo,27)...
    ,AcceptedHeight2(DumpNo,28),AcceptedHeight2(DumpNo,29)...
    );
...
fprintf(fid3,'%d %g %g %g %g %g %g %g %g %g %g %g %g %g %g\n', DumpNo...
    ...
    ,AmpMatlab1(DumpNo,10),AmpMatlab1(DumpNo,11),AmpMatlab1(DumpNo,12)...
    ,AmpMatlab1(DumpNo,13),AmpMatlab1(DumpNo,14));

fprintf(fid4,'%d %g %g %g %g %g %g %g %g %g %g %g %g %g %g\n', DumpNo...
    ...
    ,AmpMatlab2(DumpNo,10),AmpMatlab2(DumpNo,11),AmpMatlab2(DumpNo,12)...
    ,AmpMatlab2(DumpNo,13),AmpMatlab2(DumpNo,14));
